    ...
    <SafeAreaProvider>
      <SafeAreaView>
        <ScrollView>
          ...
          <Text>
            OTA working setup with EAS UPDATE working 4.0
          </Text>
          <Text>
            {"\n"}
          </Text>
          ...
          <Text>
            Below 2 lib are kept with specific version to avoid dependency issues with reanimated-carousel bottom-sheet
